...
enum DuoChaosCopy {
    ...
    static func almost() -> String {
        line([
        [
            "en": "Almost. So close it hurts.",
            "ru": "Почти. Так близко, что обидно.",
            "de": "Fast. So nah, es tut weh.",
            "es": "Casi. Tan cerca que duele.",
            "fr": "Presque. Ça fait mal.",
            "ja": "惜しい。近すぎて痛い。",
            "ko": "아깝다. 너무 가까웠어.",
            "ar": "تقريباً. قريب لدرجة الوجع.",
            "it": "Quasi. Così vicino che fa male.",
            "zh-Hans": "差一点。近得心疼。",
            "zh-Hant": "差一點。近得心疼。",
            "pt-PT": "Quase. Tão perto que dói."
        ],
        [
            "en": "99%. One more try.",
            "ru": "99%. Ещё разок.",
            ...
            "ja": "99%。もう一回。",
            "ko": "99%. 한 번 더.",
            "ar": "٩٩٪. جرّب مرة ثانية.",
            "it": "99%. Ancora una volta.",
            "zh-Hans": "99%。再试一次。",
            "zh-Hant": "99%。再試一次。",
            "pt-PT": "99%. Tenta outra vez."
        ],
        [
            "en": "Edge of greatness. Again.",
            "ru": "На краю величия. Ещё раз.",
            "de": "Am Rand der Größe. Nochmal.",
            "es": "Al borde. Otra vez.",
            "fr": "Au bord. Encore.",
            "ja": "あと一歩。もう一度。",
            "ko": "거의 다 왔어. 다시.",
            "ar": "على الحافة. مرة ثانية.",
            "it": "Quasi grandezza. Di nuovo.",
            "zh-Hans": "差临门一脚。再来。",
            "zh-Hant": "差臨門一腳。再來。",
            "pt-PT": "Quase lá. Outra vez."
        ],
        [
            "en": "Nearly. Tiny chaos.",
            "ru": "Почти. Чуть-чуть хаоса.",
            "de": "Beinahe. Mini-Chaos.",
            "es": "Casi. Mini caos.",
            "fr": "Presque. Mini chaos.",
            "ja": "ほぼ正解。ちょいカオス。",
            "ko": "거의. 살짝 카오스.",
            "ar": "تقريباً. فوضى صغيرة.",
            "it": "Quasi. Mini caos.",
            "zh-Hans": "几乎。一点点乱。",
            "zh-Hant": "幾乎。一點點亂。",
            "pt-PT": "Quase. Mini caos."
        ],
        ])
    }
    ...
    static func wrongReveal(_ answer: String) -> String {
        let template = line([
        [
            "en": "Nope. It's {ANSWER}. We move.",
            "ru": "Не. Это {ANSWER}. Идём дальше.",
            "de": "Nope. Es ist {ANSWER}. Weiter.",
            "es": "Nope. Es {ANSWER}. Seguimos.",
            "fr": "Nope. C’est {ANSWER}. On avance.",
            "ja": "違う。答えは{ANSWER}。次へ。",
            "ko": "아니야. 답은 {ANSWER}. 가자.",
            "ar": "لا. الجواب {ANSWER}. نكمل.",
            "it": "Nope. È {ANSWER}. Avanti.",
            "zh-Hans": "不对。是{ANSWER}。继续。",
            "zh-Hant": "不對。是{ANSWER}。繼續。",
            "pt-PT": "Nope. É {ANSWER}. Seguimos."
        ],
        [
            "en": "Ouch. Answer was {ANSWER}.",
            "ru": "Ауч. Ответ — {ANSWER}.",
            "de": "Autsch. Antwort: {ANSWER}.",
            "es": "Ay. Era {ANSWER}.",
            "fr": "Aïe. C’était {ANSWER}.",
            "ja": "痛い。答えは{ANSWER}。",
            "ko": "아야. 답은 {ANSWER}.",
            "ar": "آخ. الجواب كان {ANSWER}.",
            "it": "Ahi. Era {ANSWER}.",
            "zh-Hans": "哎。答案是{ANSWER}。",
            "zh-Hant": "哎。答案是{ANSWER}。",
            "pt-PT": "Ai. Era {ANSWER}."
        ],
        [
            "en": "Plot twist: {ANSWER}.",
            "ru": "Твист: {ANSWER}.",
            "de": "Plot twist: {ANSWER}.",
            "es": "Plot twist: {ANSWER}.",
            "fr": "Plot twist : {ANSWER}.",
            "ja": "どんでん返し：{ANSWER}。",
            "ko": "반전: {ANSWER}.",
            "ar": "التويست: {ANSWER}.",
            "it": "Plot twist: {ANSWER}.",
            "zh-Hans": "剧情反转：{ANSWER}。",
            "zh-Hant": "劇情反轉：{ANSWER}。",
            "pt-PT": "Plot twist: {ANSWER}."
        ],
        [
            "en": "Close, but it's {ANSWER}.",
            "ru": "Близко, но ответ — {ANSWER}.",
            "de": "Nah dran, aber es ist {ANSWER}.",
            "es": "Cerca, pero es {ANSWER}.",
            "fr": "Proche, mais c’est {ANSWER}.",
            "ja": "近いけど、{ANSWER}だよ。",
            "ko": "가까웠어. 답은 {ANSWER}.",
            "ar": "قريب، بس الجواب {ANSWER}.",
            "it": "Vicino, ma è {ANSWER}.",
            "zh-Hans": "很接近，但是{ANSWER}。",
            "zh-Hant": "很接近，但是{ANSWER}。",
            "pt-PT": "Perto, mas é {ANSWER}."
        ],
        [
            "en": "Not today. It's {ANSWER}.",
            "ru": "Не сегодня. Это {ANSWER}.",
            "de": "Nicht heute. Es ist {ANSWER}.",
            "es": "Hoy no. Es {ANSWER}.",
            "fr": "Pas aujourd’hui. C’est {ANSWER}.",
            "ja": "今日は違う。{ANSWER}。",
            "ko": "오늘은 아니야. {ANSWER}.",
            "ar": "مو اليوم. الجواب {ANSWER}.",
            "it": "Non oggi. È {ANSWER}.",
            "zh-Hans": "今天不行。是{ANSWER}。",
            "zh-Hant": "今天不行。是{ANSWER}。",
            "pt-PT": "Hoje não. É {ANSWER}."
        ],
        ])
